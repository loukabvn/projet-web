	...
	<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
			...
			<div>
				...
				<nav class="nav nav-masthead justify-content-center float-md-end">
					...
					<a class="nav-link active" aria-current="page"
						href="<%=request.getContextPath()%>/login">Sign in</a> <a
						class="nav-link" href="<%=request.getContextPath()%>/register">Register</a>
				</nav>
			</div>
		</header>
		...
		<main class="form-signin">
			<form method="GET" action="PanelController">
				<h1 class="h3 mb-3 fw-normal">Sign in to APPNAME</h1>
				...
				<button
					...
					type="submit" name="action" value="login">Sign In</button>

				<p class="mt-5 mb-3 text-muted">
					Don't have an account? <a
						href="<%=request.getContextPath()%>/register">Sign up now</a>
				</p>
			</form>
		</main>
